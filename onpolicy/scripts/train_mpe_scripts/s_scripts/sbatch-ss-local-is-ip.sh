...
# IP, CI=26, CC=1.0
sbatch -n 1 --cpus-per-task=8 --gpus=1 --gres=gpumem:2000m --job-name="IP GPU" --time=48:00:00 --mem-per-cpu=4096 --mail-type=BEGIN,END --mail-user=miperez@ethz.ch --wrap="./call_experiment.sh ${ip_script_name} 0 26 1.0"
sbatch -n 1 --cpus-per-task=8 --gpus=1 --gres=gpumem:2000m --job-name="IP GPU" --time=48:00:00 --mem-per-cpu=4096 --mail-type=BEGIN,END --mail-user=miperez@ethz.ch --wrap="./call_experiment.sh ${ip_script_name} 1 26 1.0"
sbatch -n 1 --cpus-per-task=8 --gpus=1 --gres=gpumem:2000m --job-name="IP GPU" --time=48:00:00 --mem-per-cpu=4096 --mail-type=BEGIN,END --mail-user=miperez@ethz.ch --wrap="./call_experiment.sh ${ip_script_name} 2 26 1.0"
sbatch -n 1 --cpus-per-task=8 --gpus=1 --gres=gpumem:2000m --job-name="IP GPU" --time=48:00:00 --mem-per-cpu=4096 --mail-type=BEGIN,END --mail-user=miperez@ethz.ch --wrap="./call_experiment.sh ${ip_script_name} 3 26 1.0"
sbatch -n 1 --cpus-per-task=8 --gpus=1 --gres=gpumem:2000m --job-name="IP GPU" --time=48:00:00 --mem-per-cpu=4096 --mail-type=BEGIN,END --mail-user=miperez@ethz.ch --wrap="./call_experiment.sh ${ip_script_name} 4 26 1.0"
