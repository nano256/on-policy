...
from onpolicy.envs.sisl.SISL_env import SISLEnv
...
def main(args):
    ...
    if all_args.share_policy:
        if all_args.algorithm_name == "crmappo":
            from onpolicy.runner.shared.sisl_comm_runner import (
                SISLCommunicationRunner as Runner,
            )
        else:
            NotImplementedError("SISL environment not available for this mode.")
