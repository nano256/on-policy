...
class R_MAPPOPolicy:
    ...
    def get_values(self, cent_obs, rnn_states_critic, masks):
        ...
        :return values: (torch.Tensor) value function predictions.
        """
        # Compared to the original code base, we shifted this transform into the policy to achieve homogeneous data passing.
        cent_obs = np.concatenate(cent_obs)
        rnn_states_critic = np.concatenate(rnn_states_critic)
